...
<head>
  ...
  <title>Termly Fee Transaction</title>
                            ...
                            <div class="card-body">
                                <form action="" id="dateForm">
                                    <div class="form-group">
                                        ...
                                        <option selected="selected">First Term 2023/2024</option>
                ...
                <div class="card card-secondary card-outline">
                    <div class="card-header">
                        <h3 class="card-title text-bold">
                            ...
                            <span id="dis_date">2022/2023 First Term Fee Transactions</span>
                        </h3>
                    </div>
