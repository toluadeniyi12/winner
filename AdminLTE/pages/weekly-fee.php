...
<head>
  ...
  <title>Weekly Fee Transaction</title>
                            ...
                            <div class="card-body">
                                <form action="" id="dateForm">
                                    <div class="form-group">
                                        ...
                                        <option selected="selected">Week 1</option>
                                        <option>Week2</option>
                                        <option>Week3</option>
                                        <option>Week4</option>
                                    </select>
                ...
                <div class="card card-secondary card-outline">
                    <div class="card-header">
                        <h3 class="card-title text-bold">
                            ...
                            <span id="dis_date">23 Jan, 2023 to 29 Jan, 2023 (Week 4) Fee Transaction</span>
                        </h3>
                    </div>
